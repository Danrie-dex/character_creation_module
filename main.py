...
def attack(char_name: str, char_class: str) -> str:
    """Depending on the class, the damage inflicted on the enemy is \
                                                        determined."""
...
def defence(char_name: str, char_class: str) -> str:
    """Depending on the class, the amount of blocked damage is determined."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Depending on the class, the type and strength of the special \
                                    skill of the class is indicated."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Depending on the class, it tells about your choice of class."""
    if char_class == 'warrior':
